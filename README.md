...
|-------|-------------|---------|
| [facebook-group-monitor](./facebook-group-monitor/) | Monitor Facebook groups with Playwright browser automation. Scrapes new posts, captures screenshots for LLM vision analysis. | 1.0.0 |
